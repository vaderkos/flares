...
export const LowerDashCaseInfoStatuses = {
    'continue':                         S[100],
...
export const LowerDashCaseSuccessStatuses = {
    'ok':                               S[200],
    'created':                          S[201],
    'accepted':                         S[202],
...
export const LowerDashCaseRedirectStatuses = {
...
export const LowerDashCaseClientStatuses = {
    'bad-request':                      S[400],
    'unauthorized':                     S[401],
...
export const LowerDashCaseServerStatuses = {
    'internal':                         S[500],
...
export type LowerDashCaseInfoStatuses = typeof LowerDashCaseInfoStatuses
export type LowerDashCaseSuccessStatuses = typeof LowerDashCaseSuccessStatuses
export type LowerDashCaseRedirectStatuses = typeof LowerDashCaseRedirectStatuses
export type LowerDashCaseClientStatuses = typeof LowerDashCaseClientStatuses
export type LowerDashCaseServerStatuses = typeof LowerDashCaseServerStatuses
